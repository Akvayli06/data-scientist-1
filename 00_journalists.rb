...
def journalists()
    ...
    journalists_nbr = journalists_c

    return journalists_nbr.count
end
puts journalists
...
def handle_count()
    ...
    handle_c = journalists_c

    return handle_c.min { |a, b| a.length <=> b.length }
end
...
def handle_five()
    ...
    handle_f = journalists_c

    return handle_f.count(5.to_s)
end
puts handle_five
...
def handle_alphabet()
    ...
    handle_alpha = journalists_c

    return handle_alpha.sort
end
puts handle_alphabet


def handle_find()

    puts "Quelle est la position dans l'array de la personne"
    handle_fi = journalists_c

    return handle_fi.index { |x| x == "@epenser" }
end
puts handle_find
